        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="post" action="<?php echo route('admin.settings.save') ?>" enctype="multipart/form-data">
                    ...
                    <hr>
					<div class="form-group">
					    <label for="aliases" class="form-label fw-bold d-block"><?php ee('Premium Aliases') ?> <?php echo file_exists(STORAGE.'/app/aliases.txt') ? '<span class="float-end text-success">'.e('Text file detected').'</span>' : '' ?></label>
