<div class="d-flex align-items-center mb-5">
    <div>
        ...
        <h1 class="h3"><?php echo $user->email ?><?php if($user->verified) echo '<span class="badge bg-success ms-2">'.e('Verified').'</span>' ?></h1>
    </div>
    <div class="ms-auto">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.users.view', [$user->id]) ?>"><?php ee('Links') ?></a>
                    <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.bio', ['userid' => $user->id]) ?>"><?php ee('Bio Pages') ?></a>
                    <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.qr', ['userid' => $user->id]) ?>"><?php ee('QR Codes') ?></a>
                    <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.payments', ['userid' => $user->id]) ?>"><?php ee('Payments') ?></a>
                    <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.subscriptions', ['userid' => $user->id]) ?>"><?php ee('Subscriptions') ?></a>
                    <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.domains', ['userid' => $user->id]) ?>"><?php ee('Domains') ?></a>
                </div>
            </div>
        </div>
    </div>
