...
<div class="row">
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="card-title fw-bold mb-0"><?php ee('New Links') ?></h5>
            </div>
    ...
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="card-title fw-bold mb-0"><?php ee('Top Links') ?></h5>
            </div>
            <div class="card-body no-checkbox">
...
<div class="row">
        ...
        <div class="card shadow-sm">
            <div class="card-header">                
                <div class="d-flex align-items-center">
                    <h5 class="card-title fw-bold mb-0"><?php ee('Users') ?></h5>
                    <div class="ms-auto">
                        <a href="<?php echo route('admin.users') ?>" class="btn btn-sm btn-secondary rounded"><?php ee('View All') ?></a>
                    </div>
                </div>
            </div>    
    ...
    <div class="col-md-6">
        <div class="card flex-fill shadow-sm">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h5 class="card-title fw-bold mb-0"><?php ee('Subscriptions') ?></h5>
                    <div class="ms-auto">
                        <a href="<?php echo route('admin.subscriptions') ?>" class="btn btn-sm btn-secondary rounded"><?php ee('View All') ?></a>
                    </div>                    
                </div>
            </div>
            <div class="table-responsive">
...
<div class="row">
    <div class="col-md-6">
        <div class="card flex-fill shadow-sm">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h5 class="card-title fw-bold mb-0"><?php ee('Payments') ?></h5>
                    <div class="ms-auto">
                        <a href="<?php echo route('admin.payments') ?>" class="btn btn-sm btn-secondary rounded"><?php ee('View All') ?></a>
                    </div>                     
                </div> 
            </div>
            <div class="table-responsive">
    ...
    <div class="col-md-6">
        <div class="card flex-fill shadow-sm">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h5 class="card-title fw-bold mb-0"><?php ee('Reported Links') ?></h5>
                    <div class="ms-auto">
                        <a href="<?php echo route('admin.links.report') ?>" class="btn btn-sm btn-secondary rounded"><?php ee('View All') ?></a>
                    </div>                    
                </div>
            </div>
            <div class="table-responsive">
